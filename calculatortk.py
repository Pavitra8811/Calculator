...
def calculate():
    ...
    if equation!="":
      try:
        ...
        result="error"
        equation=""
    labres.config(text=result)


labres=Label(root,width=25,height=2,text="",font=("arial",30))
labres.pack()
...
Button(root,text="-",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show("-")).place(x=432,y=200)
...
Button(root,text="+",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show("+")).place(x=432,y=300)
